...
const setScore = () => {
  const humanScore = document.getElementById("humanScore").innerText;
};
...
function singleRound(clicked_id) {
  ...
  document.getElementById("result").innerHTML =
    "You picked: " + clicked_id + ". " + "The AI picked: " + compChoice + ".";
